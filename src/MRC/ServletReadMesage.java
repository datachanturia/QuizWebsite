...
/**
 * Servlet implementation class ServletReadMesage
 */
@WebServlet("/ServletReadMesage")
public class ServletReadMesage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletReadMesage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			rd = request.getRequestDispatcher("./MRC/Message.jsp");
