...
/**
 * Servlet implementation class ServletChallengeList
 */
@WebServlet("/ServletChallengeList")
public class ServletChallengeList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletChallengeList() {
        super();
