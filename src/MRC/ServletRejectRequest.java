...
/**
 * Servlet implementation class ServletRejectRequest
 */
@WebServlet("/ServletRejectRequest")
public class ServletRejectRequest extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletRejectRequest() {
        super();
